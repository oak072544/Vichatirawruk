...
#include "esp32_digital_output_demo.h" /* Model's header file */
#include "rtwtypes.h"
 ...
 *===============================================================
 * Simulink model name: esp32_digital_output_demo
 * Note that:
 ...
 * Task 0 (Function name: vTaskFunctionBaseRate), base rate: 0.3 seconds, priority: 0
...
{
  const TickType_t vPeriodicTaskPreiod = 300/portTICK_PERIOD_MS;
  ...
  while (1) {
    ...
    esp32_digital_output_demo_step();
...
/*
 * Spawn esp32_digital_output_demo_main as an independent FreeRTOS task
 * from your application code.
 */
void app_main(void)
{
  /* Initialize model */
  esp32_digital_output_demo_initialize();
