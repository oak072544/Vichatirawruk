...
typedef struct {
  ...
  boolean_T y;                         /* '<Root>/MATLAB Function2' */
  boolean_T y_a;                       /* '<Root>/MATLAB Function1' */
  boolean_T y_m;                       /* '<Root>/MATLAB Function' */
} B_esp32_adc_demo_T;
 ...
 *
 * '<Root>' : 'esp32_adc_demo'
 * '<S1>'   : 'esp32_adc_demo/MATLAB Function'
 * '<S2>'   : 'esp32_adc_demo/MATLAB Function1'
 * '<S3>'   : 'esp32_adc_demo/MATLAB Function2'
 */
